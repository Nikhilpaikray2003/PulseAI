...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('patient', '0002_heartvital_heartdisease_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='heartvital',
            name='ST_Slope',
            field=models.CharField(choices=[('Flat', 'Flat'), ('Up', 'Upsloping'), ('Down', 'Downsloping')], max_length=255),
        ),
